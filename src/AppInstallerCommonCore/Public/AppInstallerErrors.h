...
#define APPINSTALLER_CLI_ERROR_UNSUPPORTED_SEARCH_QUERY         ((HRESULT)0x8a150041)
#define APPINSTALLER_CLI_ERROR_RESTSOURCE_ENDPOINT_NOT_FOUND    ((HRESULT)0x8a150042)
